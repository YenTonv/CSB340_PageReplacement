...
public class PageGenerator {
	 ...
	 */
	public int[] getReferenceString(int referenceStringOption) {
		int[] rStr1 = {7,0,1,2,0,3,0,4,2,3,0,3,2,1,2,0,1,7,0,1};
		int[] rStr2 = {8,1,0,7,3,0,3,4,5,3,5,2,0,6,8,4,8,1,5,3};
		int[] rStr3 = {4,6,4,8,6,3,6,0,5,9,2,1,0,4,6,3,0,6,8,4};

		switch (referenceStringOption) {
			case 1:
				return rStr1;
			case 2:
				return rStr2;
			case 3:
				return rStr3;
			default:
				throw new IllegalArgumentException("Invalid reference string option: " + referenceStringOption);
		}
	}
